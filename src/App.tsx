        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 md:p-6 backdrop-blur-xl bg-black/80 animate-fadeIn hover:cursor-default overflow-y-auto">
          <div className="w-full max-w-5xl bg-[#090C16] border border-white/5 rounded-[2.5rem] p-6 md:p-8 relative shadow-2xl max-h-[90vh] overflow-y-auto custom-scrollbar">
            <button
              ...
              className="absolute top-6 right-6 p-2 rounded-full bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all text-white/50 hover:text-white cursor-pointer flex items-center justify-center"
              title="Close Panel"
            >
              <X className="w-4 h-4" />
            </button>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-1.5 p-1 bg-white/5 border border-white/10 rounded-2xl">
                <button
                  ...
                  className={`flex-1 py-2.5 text-[10px] font-black uppercase tracking-wider rounded-xl transition-all flex items-center justify-center gap-2 cursor-pointer ${
                    appMode === "player"
                      ? "bg-sky-500 text-slate-950 font-bold shadow-md shadow-sky-500/20"
                      : "text-gray-400 hover:text-white"
                  }`}
                >
                  <Eye className="w-3.5 h-3.5" /> Play Mode
                </button>
                <button
                  onClick={() => {
                    setAppMode("creator");
                ...
                >
                  <Sparkles className="w-3.5 h-3.5 text-amber-950" /> Writer Mode
                </button>
              </div>
                ...
                {appMode === "creator" && (
                  <button
                    ...
                    className={`w-full py-4 px-6 rounded-2xl flex items-center justify-between font-bold text-xs uppercase tracking-wider text-left border ${
                      showCreatorPanel
                        ? "bg-amber-500/10 border-amber-400/50 text-amber-500 dark:text-amber-400 font-extrabold"
            ...
            >
              ...
              <div className="relative w-full max-w-4xl mx-auto py-12 px-6 rounded-[3rem] overflow-visible border border-white/5 bg-white/[0.01] backdrop-blur-[2px]">
                ...
                <div className="relative z-10 space-y-6">
                  ...
                  <motion.h1 
                    ...
                    className="text-4xl sm:text-6xl md:text-8xl font-serif font-medium tracking-tight text-white leading-none"
                  >
                    Orchestrate <br />
              ...
              <div className="flex flex-col md:flex-row gap-6 w-full max-w-5xl z-10">
                ...
                <button
                  ...
                  className="group relative flex-1 aspect-[16/10] md:aspect-[10/13] bg-[#FCF8F8] border border-rose-100/50 rounded-3xl overflow-hidden shadow-2xl hover:shadow-rose-100 transition-all duration-700 transform hover:-translate-y-2 flex flex-col justify-end p-6 md:p-10 text-left cursor-pointer"
                >
                  <img
                    src={genreRomanceImg}
                  ...
                  <div className="relative z-10 transition-transform duration-700 group-hover:-translate-y-2">
                    <h2 className="text-2xl md:text-3xl font-serif italic text-rose-950 leading-tight mb-2">
                      Rose & Rapture
                    </h2>
                ...
                <button
                  ...
                  onMouseLeave={() => setHoveredGenre(null)}
                  className="group relative flex-1 aspect-[16/10] md:aspect-[10/13] bg-[#0A0C10] border border-white/5 rounded-3xl overflow-hidden shadow-2xl hover:shadow-white/5 transition-all duration-700 transform hover:-translate-y-2 flex flex-col justify-end p-6 md:p-10 text-left cursor-pointer"
                >
                  <img
                    src={genreCrimeImg}
                  ...
                  <div className="relative z-10 text-white transition-transform duration-700 group-hover:-translate-y-2">
                    <h2 className="text-xl md:text-2xl font-mono uppercase tracking-[0.1em] text-white leading-tight mb-3">
                      Shadows & Sin
                    </h2>
                ...
                <button
                  ...
                  onMouseLeave={() => setHoveredGenre(null)}
                  className="group relative flex-1 aspect-[16/10] md:aspect-[10/13] bg-[#0D0A14] border border-purple-500/10 rounded-3xl overflow-hidden shadow-2xl hover:shadow-purple-900/30 transition-all duration-700 transform hover:-translate-y-2 flex flex-col justify-end p-6 md:p-10 text-left cursor-pointer"
                >
                  <img
                  ...
                  <div className="relative z-10 text-purple-100 transition-transform duration-700 group-hover:-translate-y-2">
                    <h2 className="text-2xl md:text-3xl font-serif italic tracking-wide text-white leading-tight mb-3">
                      Veiled Realms
                    </h2>
                    ...
                    <div className={settings.readerMode ? "max-w-2xl mx-auto w-full space-y-12" : "grid grid-cols-1 lg:grid-cols-[1fr_380px] gap-16 lg:gap-24"}>
                      ...
                      >
                        <div className="space-y-6">
                          ...
                          <h2
                            className={`text-4xl sm:text-6xl md:text-8xl leading-none md:leading-[0.85] transition-all duration-1000 ${headingFont} ${
                              genre === "romance"
      ...
      {showCreatorPanel && appMode === "creator" && (
        <>
          ...
          >
            ...
            {/* Selector Tabs */}
            <div className="flex overflow-x-auto no-scrollbar flex-nowrap border-b border-white/5 bg-[#0b1019] p-1 gap-1 scroll-smooth shrink-0">
              {(["outline", "grimoire", "parameters", "ripples", "collab", "export"] as const).map((tab) => (
                <button
                  key={tab}
                  onClick={() => setCreatorTab(tab)}
                  className={`py-2 px-4 text-[10px] font-black uppercase tracking-wider rounded transition-all cursor-pointer shrink-0 ${
                    creatorTab === tab
